...
package com.discovery_marc.hr_chat_box.controller;
...
import com.discovery_marc.hr_chat_box.User;
import com.discovery_marc.hr_chat_box.UserId;
import com.discovery_marc.hr_chat_box.service.UserService;
 ...
 * @see User
 */
@RestController("HR_Chat_Box.UserController")
@Api(value = "UserController", description = "Exposes APIs to work with User resource.")
@RequestMapping("/HR_Chat_Box/User")
public class UserController {

    private static final Logger LOGGER = LoggerFactory.getLogger(UserController.class);

    @Autowired
	@Qualifier("HR_Chat_Box.UserService")
    ...
    @ApiOperation(value = "Returns the User instance associated with the given composite-id.")
    @RequestMapping(value = "/composite-id", method = RequestMethod.GET)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public User getUser(@RequestParam("sapSiteNumber") Integer sapSiteNumber,@RequestParam("nameLine2") String nameLine2,@RequestParam("userId") String userId,@RequestParam("password") String password) throws EntityNotFoundException {

        UserId userIdInstance = new UserId();
        userIdInstance.setSapSiteNumber(sapSiteNumber);
        userIdInstance.setNameLine2(nameLine2);
        userIdInstance.setUserId(userId);
        userIdInstance.setPassword(password);

        LOGGER.debug("Getting User with id: {}" , userIdInstance);
        User user = userService.getById(userIdInstance);
    ...
    @ApiOperation(value = "Updates the User instance associated with the given composite-id.")
    @RequestMapping(value = "/composite-id", method = RequestMethod.PUT)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public User editUser(@RequestParam("sapSiteNumber") Integer sapSiteNumber,@RequestParam("nameLine2") String nameLine2,@RequestParam("userId") String userId,@RequestParam("password") String password, @RequestBody User user) throws EntityNotFoundException {

        user.setSapSiteNumber(sapSiteNumber);
        user.setNameLine2(nameLine2);
        user.setUserId(userId);
        user.setPassword(password);

        LOGGER.debug("User details with id is updated with: {}" , user);

        return userService.update(user);
    }


    @ApiOperation(value = "Deletes the User instance associated with the given composite-id.")
    @RequestMapping(value = "/composite-id", method = RequestMethod.DELETE)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteUser(@RequestParam("sapSiteNumber") Integer sapSiteNumber,@RequestParam("nameLine2") String nameLine2,@RequestParam("userId") String userId,@RequestParam("password") String password) throws EntityNotFoundException {
        ...
        User user = userService.delete(userIdInstance);
